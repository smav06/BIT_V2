...
@section('title', "Personal Issuance")
    ...
    <script type="text/javascript"> 
        ...
        $(document).ready(function() {
            $('#AddPersonal').on('click', function(e) {
                e.preventDefault();
                if($('#personal').parsley().validate()==true)
                    {
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            $('#AddBusiness').on('click', function(){
                ...
                fd.append('middlename',mnameissue);
 ...
 <!-- begin #content -->
    <div id="content" class="content">
        ...
        <ol class="breadcrumb pull-right">
            ...
            <li class="breadcrumb-item"><a href="javascript:;">Certificates & Forms</a></li>
            
            <li class="breadcrumb-item active">Personal</li>
        </ol>
        <!-- end breadcrumb -->
        <!-- begin page-header -->
        <h1 class="page-header">Certificates & Forms<small> Issuances for residents.</small></h1>
        <!-- end page-header -->
            ...
            <div>
                ...
                <div class="panel panel-inverse">
                    ...
                    <div class="panel-heading">
                        ...
                        <h4 class="panel-title">Adding Personal Issuance</h4>
                    </div>
                    <!-- end panel-heading -->
                    <!-- begin alert -->
                                                ...
                                                <tbody id="table-body">
                                                    ...
                                                    <tr >
                                                        ...
                                                        <td >
                                                             ...
                                                             <button id="issuebtn" name="issuebtn" type='button' class='btn btn-lime'  data-toggle='modal' data-target='#PersonalModal' >
                                            ...
                                            <table id="list-of-personal" class="table table-striped table-bordered ">
                                                ...
                                                <tbody >
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td >
                                                             <button type='button' class='btn btn-primary form-control IssueCertBtn' data-toggle='modal' data-target='#AddModal' >
