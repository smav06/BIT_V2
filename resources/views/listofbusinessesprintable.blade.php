    ...
    <table style="font-size: 15px; width: 100%;" border="1" cellpadding="5">
      <thead>
        <tr>
          ...
          <th style="text-align: center">Business Nature </th>

          <th style="text-align: center">Barangay Zone </th>
      ...
      <tbody>
        ...
        <tr>
          ...
          <td style="border:1px solid; text-align: center;">{{$row->BUSINESS_NAME}}</td>
          <td style="border:1px solid; text-align: center;">{{$row->BUSINESS_NATURE_NAME}}</td>
          <td style="border:1px solid; text-align: center;">{{$row->BARANGAY_ZONE_NAME}}</td>
          <td style="border:1px solid; text-align: center;">{{$row->BUSINESS_ADDRESS}}</td>
          <td style="border:1px solid; text-align: center;">{{$row->OR_NUMBER}}</td> 
