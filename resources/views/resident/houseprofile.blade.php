...
@section('page-js')
   ...
   var table = $("#data-table-default").DataTable({
                  ...
                  columns:
                  [  
                      { data: "HOUSEHOLD_ID", name: "HI.HOUSEHOLD_ID", visible: false},
                      { data: "HOME_OWNERSHIP", name: "HI.HOME_OWNERSHIP"},
                      { data: "PERSON_STAYING_IN_HOUSEHOLD", name: "HI.PERSON_STAYING_IN_HOUSEHOLD"},
                      { data: "HOME_MATERIALS",name: "HI.HOME_MATERIALS", searchable: false},
                      
                      { data: "LASTNAME", name: "T.LASTNAME", visible: false, searchable: false},
                      { data: "FIRSTNAME", name: "T.FIRSTNAME", visible: false, searchable: false},
                      { data: "MIDDLENAME", name: "T.MIDDLENAME", visible: false, searchable: false},

                      { data: "TOILET_HOME", name: "HI.TOILET_HOME", visible: false,searchable: false},
                      { data: "PLAY_AREA_HOME", name: "HI.PLAY_AREA_HOME", visible: false, searchable: false},
                      { data: "BEDROOM_HOME", name: "HI.BEDROOM_HOME", visible: false, searchable: false},
                      { data: "DINING_ROOM_HOME", name: "HI.DINING_ROOM_HOME", visible: false, searchable: false},
                      { data: "SALA_HOME", name: "HI.SALA_HOME", visible: false, searchable: false},
                      { data: "KITCHEN_HOME", name: "HI.KITCHEN_HOME", visible: false, searchable: false},

                      { data: "WATER_UTILITIES", name: "HI.WATER_UTILITIES", visible: false, searchable: false},
                      { data: "ELECTRICITY_UTILITIES", name: "HI.ELECTRICITY_UTILITIES", visible: false, searchable: false},
                      { data: "AIRCON_UTILITIES", name: "HI.AIRCON_UTILITIES", visible: false, searchable: false},
                      { data: "PHONE_UTILITIES", name: "HI.PHONE_UTILITIES", visible: false, searchable: false},
                      { data: "COMPUTER_UTILITIES", name: "HI.COMPUTER_UTILITIES", visible: false, searchable: false},
                      { data: "INTERNET_UTILITIES", name: "HI.INTERNET_UTILITIES", visible: false, searchable: false},
                      { data: "TV_UTILITIES", name: "HI.TV_UTILITIES", visible: false, searchable: false},
                      { data: "CD_PLAYER_UTILITIES", name: "HI.CD_PLAYER_UTILITIES", visible: false, searchable: false},
                      { data: "RADIO_UTILITIES", name: "HI.RADIO_UTILITIES", visible: false, searchable: false},
                      { data: "COMICS_ENTERTAINMENT", name: "HI.COMICS_ENTERTAINMENT", visible: false, searchable: false},
                      { data: "NEWS_PAPER_ENTERTAINMENT", name: "HI.NEWS_PAPER_ENTERTAINMENT", visible: false, searchable: false},
                      { data: "PETS_ENTERTAINMENT", name: "HI.PETS_ENTERTAINMENT", visible: false, searchable: false},
                      { data: "BOOKS_ENTERTAINMENT", name: "HI.BOOKS_ENTERTAINMENT", visible: false, searchable: false},
                      { data: "STORY_BOOKS_ENTERTAINMENT", name: "HI.STORY_BOOKS_ENTERTAINMENT", visible: false,searchable: false},
                      { data: "TOYS_ENTERTAINMENT", name: "HI.TOYS_ENTERTAINMENT", visible: false, searchable: false},
                      { data: "BOARD_GAMES_ENTERTAINMENT", name: "HI.BOARD_GAMES_ENTERTAINMENT", visible: false, searchable: false},
                      { data: "PUZZLES_ENTERTAINMENT", name: "HI.PUZZLES_ENTERTAINMENT", visible: false, searchable: false},
                      { data: "NUMBER_OF_ROOMS", name: "HI.NUMBER_OF_ROOMS", visible: false, searchable: false},


                      { render:function()
                        {
                          return "<button type='button' class='btn btn-success mother-btn' data-toggle='modal' data-target='#UpdateModal'><i class='fa fa-edit'></i> Edit</button>";
                        }, 
                        searchable: false}, 
                  ]
              });    
...
<!--     <script type="text/javascript">
    ...
    // function ViewHousehold(toiletutil,playareutil,bedroomutil,diningutil,sala,kitchenutil,waterutil,electricutil,airconutil,phoneutil,computerutil,internetutil,tvutil,util,radioutil,comicsutil,newsutil,petsutil,booksutil,storybookutil,toyutil,puzzleutil,norooms)
    ...
    $(document).ready(function() {
        $('#data-table-default').on('click','.viewCategory', function() {
           ...
           var toilet = $(this).closest('tbody tr').find('td:eq(7)').html();
           var parea = $(this).closest('tbody tr').find('td:eq(8)').html();
           var bedroom = $(this).closest('tbody tr').find('td:eq(9)').html();
           var dining = $(this).closest('tbody tr').find('td:eq(10)').html();
           var sala = $(this).closest('tbody tr').find('td:eq(11)').html();
           var kitchen = $(this).closest('tbody tr').find('td:eq(12)').html();
           var water = $(this).closest('tbody tr').find('td:eq(13)').html();
           var electric = $(this).closest('tbody tr').find('td:eq(14)').html();
           var aircon = $(this).closest('tbody tr').find('td:eq(15)').html();
           var phone = $(this).closest('tbody tr').find('td:eq(16)').html();
           var computer = $(this).closest('tbody tr').find('td:eq(17)').html();
           var internet = $(this).closest('tbody tr').find('td:eq(18)').html();
           var tv = $(this).closest('tbody tr').find('td:eq(19)').html();
           var cdplayer = $(this).closest('tbody tr').find('td:eq(20)').html();
           var radio = $(this).closest('tbody tr').find('td:eq(21)').html();
           var comics = $(this).closest('tbody tr').find('td:eq(22)').html();
           var newspaper = $(this).closest('tbody tr').find('td:eq(23)').html();
           var pets = $(this).closest('tbody tr').find('td:eq(24)').html();
           var books = $(this).closest('tbody tr').find('td:eq(25)').html();
           var storybooks = $(this).closest('tbody tr').find('td:eq(26)').html();
           var toys = $(this).closest('tbody tr').find('td:eq(27)').html();
           var bgames = $(this).closest('tbody tr').find('td:eq(28)').html();
           var puzzle = $(this).closest('tbody tr').find('td:eq(29)').html();
           var lastname = $(this).closest('tbody tr').find('td:eq(31)').html();
           var middlename = $(this).closest('tbody tr').find('td:eq(32)').html();
           var firstname = $(this).closest('tbody tr').find('td:eq(33)').html();

           var fullname = lastname + ", " + firstname + " " + middlename + ".";   
           $('#view_db_name').text(fullname);
           $('#viewnorooms').val($(this).closest("tbody tr").find("td:eq(30)").html());


           if (toilet == 1) { document.getElementById('viewtoilet').checked = true;} else if (toilet == 0) { document.getElementById('viewtoilet').checked = false; }
           if (parea == 1) { document.getElementById('viewplayarea').checked = true;} else if (parea == 0) { document.getElementById('viewplayarea').checked = false; }
           if (bedroom == 1) { document.getElementById('viewbedroom').checked = true;} else if (bedroom == 0) { document.getElementById('viewbedroom').checked = false; }
           if (dining == 1) { document.getElementById('viewdining').checked = true;} else if (dining == 0) { document.getElementById('viewdining').checked = false; }
           if (sala == 1) { document.getElementById('viewsala').checked = true;} else if (sala == 0) { document.getElementById('viewsala').checked = false; }
           if (kitchen == 1) { document.getElementById('viewkitchen').checked = true;} else if (kitchen == 0) { document.getElementById('viewkitchen').checked = false; }
           if (water == 1) { document.getElementById('viewwater').checked = true;} else if (water == 0) { document.getElementById('viewwater').checked = false; }
           if (electric == 1) { document.getElementById('viewelectric').checked = true;} else if (electric == 0) { document.getElementById('viewelectric').checked = false; }
           if (aircon == 1) { document.getElementById('viewaircon').checked = true;} else if (aircon == 0) { document.getElementById('viewaircon').checked = false; }
           if (phone == 1) { document.getElementById('viewphone').checked = true;} else if (phone == 0) { document.getElementById('viewphone').checked = false; }
           if (computer == 1) { document.getElementById('viewcomputer').checked = true;} else if (computer == 0) { document.getElementById('viewcomputer').checked = false; }
           if (internet == 1) { document.getElementById('viewinternet').checked = true;} else if (internet == 0) { document.getElementById('viewbedroom').checked = false; }
           if (tv == 1) { document.getElementById('viewtv').checked = true;} else if (tv == 0) { document.getElementById('viewtv').checked = false; }
           if (cdplayer == 1) { document.getElementById('viewcd').checked = true;} else if (cdplayer == 0) { document.getElementById('viewcd').checked = false; }
           if (radio == 1) { document.getElementById('viewradio').checked = true;} else if (radio == 0) { document.getElementById('viewradio').checked = false; }
           if (comics == 1) { document.getElementById('viewcomics').checked = true;} else if (comics == 0) { document.getElementById('viewbedroom').checked = false; }
           if (newspaper == 1) { document.getElementById('viewnspaper').checked = true;} else if (newspaper == 0) { document.getElementById('viewnspaper').checked = false; }
           if (pets == 1) { document.getElementById('viewpets').checked = true;} else if (pets == 0) { document.getElementById('viewpets').checked = false; }
           if (books == 1) { document.getElementById('viewbooks').checked = true;} else if (books == 0) { document.getElementById('viewbooks').checked = false; }
           if (storybooks == 1) { document.getElementById('viewsbooks').checked = true;} else if (storybooks == 0) { document.getElementById('viewsbooks').checked = false; }
           if (toys == 1) { document.getElementById('viewtoys').checked = true;} else if (toys == 0) { document.getElementById('viewtoys').checked = false; }
           if (bgames == 1) { document.getElementById('viewbgames').checked = true;} else if (toys == 0) { document.getElementById('viewbgames').checked = false; }
           if (puzzle == 1) { document.getElementById('viewpuzzle').checked = true;} else if (bgames == 0) { document.getElementById('viewpuzzle').checked = false; }
    ...
    <script type="text/javascript">
      $(document).ready(function() {
        ...
        $('#data-table-default tbody').on('click','tr', function() {
            ...
            var lastname = table.cell( this, 4).data();
            var firstname = table.cell( this, 5).data();
            var middlename = table.cell( this, 6).data();
            var fullname = lastname + ", " + firstname + " " + middlename + ".";   
            $('#edit_db_name').text(fullname);
            
           

            var edittoilet = table.cell( this, 7).data();           
            var parea =  table.cell( this, 8).data(); 
            var bedroom =  table.cell( this, 9).data(); 
            var dining =  table.cell( this, 10).data(); 
            var sala =  table.cell( this, 11).data(); 
            var kitchen =  table.cell( this, 12).data(); 
            var water =  table.cell( this, 13).data(); 
            var electric =  table.cell( this, 14).data(); 
            var aircon =  table.cell( this, 15).data(); 
            var phone =  table.cell( this, 16).data(); 
            var computer = table.cell( this, 17).data(); 
            var internet =  table.cell( this, 18).data(); 
            var tv =  table.cell( this, 19).data(); 
            var cdplayer =  table.cell( this, 20).data(); 
            var radio =  table.cell( this, 21).data(); 
            var comics =  table.cell( this, 22).data(); 
            var newspaper =  table.cell( this, 23).data(); 
            var pets =  table.cell( this, 24).data(); 
            var books =  table.cell( this, 25).data(); 
            var storybooks = table.cell( this, 26).data(); 
            var toys =  table.cell( this, 27).data(); 
            var bgames = table.cell( this, 28).data(); 
            var puzzle =  table.cell( this, 29).data(); 
          
           $('#EditCatID').val(table.cell( this, 0).data());           
           $('#editnumberofrooms').val(table.cell( this, 30).data());
