        ...
        $(".ORModalBtn").click(function()
            {
                ...
                $("#BusinessORNumberTxt").val($(this).closest('table tr').find('td:eq(7)').html());
                                                ...
                                                <tbody>
                                                 ...
                                                 @foreach($records as $record)
                                                    <tr >
                                                        ...
                                                        <td style="background-color: {{ $record->active_flag == 1 ? '#ddefc9' : '#ffcdcc'}}"  >{{ $record->business_nature_name }}</td>
                                                        <td style="background-color: {{ $record->active_flag == 1 ? '#ddefc9' : '#ffcdcc'}}" >{{ $record->barangay_zone_name }}</td>
                                                        <td style="background-color: {{ $record->active_flag == 1 ? '#ddefc9' : '#ffcdcc'}}" >{{ $record->business_name }}</td>
                                                        ...
                                                        <td  style="background-color: {{ $record->active_flag == 1 ? '#ddefc9' : '#ffcdcc'}}" >
                                                            ...
                                                            <button type='button' class='btn btn-warning form-control ORModalBtn' data-toggle='modal' data-target='#ORModal' id="ORModalBtn" >
                                                             ...
                                                             <button type='button' class='btn btn-lime form-control ORModalBtn' data-toggle='modal' data-target='#ORModal' id="" >
