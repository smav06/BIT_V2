    ...
    <div class="panel-body">
      ...
      .borderless{
         ...
         <table style="width: 100%; background-color: transparent">
          ...
          {{--<tr>  @foreach($barangay_info as $info)
      ...
      <table style="font-size: 15px; width: 100%;" border="1" cellpadding="5">
          ...
          <tbody>
            ...
            <tr>
                ...
                <td colspan="3" style=" text-align: center; width:13%">{{ $row->Fullname }}</td>
                <td colspan="3" style=" text-align: center; width:13%">{{ $row->BARANGAY_NAME }}</td>
                <td colspan="3" style=" text-align: center; width:13%">{{ $row->POSITION_NAME }}</td>

                <td colspan="3" style=" text-align: center; width:13%">{{ $row->Start_Term }}</td>
                <td colspan="3" style=" text-align: center; width:13%">{{ $row->End_Term }}</td>
