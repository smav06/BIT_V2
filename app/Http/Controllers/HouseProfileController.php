...
class HouseProfileController extends Controller
{
    public function index()
    {
        ...
        // ->SELECT(
        //     'HI.HOUSEHOLD_ID','HI.HOME_OWNERSHIP','HI.PERSON_STAYING_IN_HOUSEHOLD','HI.HOME_MATERIALS','HI.BARANGAY_ZONE_ADDRESS','T.LASTNAME','T.FIRSTNAME','T.MIDDLENAME',
    ...
    //         'HI.PHONE_UTILITIES','HI.COMPUTER_UTILITIES','HI.INTERNET_UTILITIES','HI.TV_UTILITIES','HI.CD_PLAYER_UTILITIES','HI.RADIO_UTILITIES','HI.COMICS_ENTERTAINMENT',
    //         'HI.NEWS_PAPER_ENTERTAINMENT','HI.PETS_ENTERTAINMENT','HI.BOOKS_ENTERTAINMENT','HI.STORY_BOOKS_ENTERTAINMENT','HI.TOYS_ENTERTAINMENT','HI.BOARD_GAMES_ENTERTAINMENT','HI.PUZZLES_ENTERTAINMENT','HI.NUMBER_OF_ROOMS','T.LASTNAME','T.MIDDLENAME','T.FIRSTNAME'
