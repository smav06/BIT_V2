...
<head>
  ...
  <meta name="robots" content="noindex">
	<div id="print_form" class="panel-body" style=" letter-spacing: 2px;">
		...
		<br>
		<br>
		<p style="text-align: left; margin-bottom: 2px; margin-left: 50px; margin-right: 50px; font-size: large;">&emsp;&emsp; Sa pamamagitan nito, kayo ay aking tinatawagan upang humarap sa akin ng personal sa ika- <u id="day">(araw)</u> ng <u id="month-year">(buwan at taon)</u>, sa takdang oras na <u id="time">(oras)</u> sa <u id="lbl_place"></u></p> 
		<p style="margin-bottom: 2px; padding: -2px;">&nbsp;</p>
		...
		<p style="margin-bottom: 2px; padding: -2px;">&nbsp;</p>
		<p style="text-align: left; margin-bottom: 2px; margin-left: 50px; margin-right: 50px; font-size: large;">&emsp;&emsp; Ginawa ngayong ika- <u id="today">(araw)</u> ng <u id="month-year-today">(buwan at taon)</u>.</p>
		<p style="margin-bottom: 2px; padding: -2px;">&nbsp;</p>
		<p style="margin-bottom: 2px; padding: -2px;">&nbsp;</p>
		<br>
		<br>
		<p style="text-align: right; margin-bottom: 2px; margin-right: 50px; font-size: large;"><strong>{{session('session_brgychairman_name')}}</strong></p> 
