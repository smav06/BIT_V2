            ...
            $('#data-table-default').on('click', '#PrintBTN', function(){
                ...
                $.ajax({
                    ...
                    $.each(response["for_print"], function(){
                        ...
                        // convert date
                        get_convert = moment(datetime).format('D;MMMM, YYYY;;h:mm a');
                        
                        date = get_convert.split(";;")[0];
                        time = get_convert.split(";;")[1];
                        get_day = date.split(";")[0];
                        get_month_year = date.split(";")[1];
                    ...
                    get_date_now = moment(new Date()).format('D;MMMM, YYYY;;h:mm a');
                    date_now = get_date_now.split(";;")[0];                    
                    get_day_now = date_now.split(";")[0];
                    get_month_year_now = date_now.split(";")[1];
                    ...
                    $("#day").text(get_day);                    
                    $("#month-year").text(get_month_year);
                    $("#time").text(time);

                    $("#today").text(get_day_now);                    
                    $("#month-year-today").text(get_month_year_now);
