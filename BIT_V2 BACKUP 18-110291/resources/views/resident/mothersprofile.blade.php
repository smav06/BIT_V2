...
@section('title', "Mother's Profile")
                    ...
                    <div class="panel panel-inverse">
                        ...
                        <div class="panel-body">
                            ...
                            <table id="data-table-default" class="table table-striped table-bordered">
                                ...
                                <tbody>
                                @foreach($MotherTable as $profile)
                               
                                <tr >

                                    <td hidden>{{$profile->MOTHERS_ID}}</td>
                                    ...
                                    @if ($profile->IS_PREGNANT == '1') 
                                    <td style="background-color: {{ $profile->ACTIVE_FLAG == 1 ? '#ddefc9' : '#ffcdcc'}}">Yes</td>
                                    @else
                                    <td style="background-color: {{ $profile->ACTIVE_FLAG == 1 ? '#ddefc9' : '#ffcdcc'}}">No</td>
                                    @endif
                                    <td style="background-color: {{ $profile->ACTIVE_FLAG == 1 ? '#ddefc9' : '#ffcdcc'}}">{{$profile->MOTHER_MOTHER_TONGUE}}</td>
                                    <td style="background-color: {{ $profile->ACTIVE_FLAG == 1 ? '#ddefc9' : '#ffcdcc'}}">{{$profile->MOTHER_OTHER_DIALECTS}}</td>
                                    <td style="background-color: {{ $profile->ACTIVE_FLAG == 1 ? '#ddefc9' : '#ffcdcc'}}">{{$profile->MOTHER_EDUCATIONAL_ATTAINMENT}}</td>
