                  ...
                  <tr>
                    ...
                    <td class="wrapper">
                      <table class="twelve columns">
                        <tr>
                          <td class="last">
                            <h4>Welcome to Barangay Profiling Information System.</h4>
                        ...
                        <tr>
                          <td class="panel">
                            ...
                            <p class="m-b-5">your new password is <b>{!!$PASSWORD!!}</b></p>
                            @else
                            <p class="m-b-5">Your username is <b>{!!$USERNAME!!}</b> and your password is <b>{!!$PASSWORD!!}</b></p>
                            @endif
                        ...
                        <table class="six columns">
                          <tr>
                           <td class="wrapper text-right valign-middle">
                            <a href="http://euc.ph/barangay-it/"> <b>Barangay IT</b></a> <i>Bringing Change to Local Government</i>
                            <div class="pull-right">
                              by <a href="http://euc.ph/"><b>EUC</b></a> & <a href="http://srg.pupqc.net/"><b>SRG</b></a>
                            </div>
                          </td>
