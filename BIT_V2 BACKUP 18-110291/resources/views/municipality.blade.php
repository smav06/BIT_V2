         ...
         <!-- begin wizard -->
                                        ...
                                        <ul>
                                            ...
                                            <li class="col-md-3 col-sm-4 col-6">
                                                <a href="#step-2">
                                                    ...
                                                    <span class="info text-ellipsis">
                                                Personal Info
                                                <small class="text-ellipsis">Name, Address, Birthdate,Municipal Position, Municipal Position Description</small>
                                            </span>
                                                </a>
                                            </li>
                                       ...
                                       <!-- begin form-group -->
                                                            <div class="form-group row m-b-10">
                                                                ...
                                                                <div class="col-md-6">
                                                                    ...
                                                                    name="municipality_name_txt" placeholder="San Jose Del Monte" 
                                                            ...
                                                            <div class="form-group row m-b-10">
                                                                ...
                                                                <div class="col-md-6">
                                                                    <input type="text" 
                                                                     ...
                                                                     name="province_name_txt" placeholder="Bulacan"
                                            ...
                                            <div id="step-2">
                                                ...
                                                <fieldset>
                                                    <!-- begin row -->
                                                       <div class="row">
                                                        <legend class="no-border f-w-700 p-b-0 m-t-0 m-b-20 f-s-16 text-inverse">Personal Info  </legend>
                                                        <div class="col-md-6">
                                                            ...
                                                            <div class="form-group row m-b-10">
                                                                ...
                                                                <div class="col-md-6">
                                                                    <input type="text" name="official_first_name_txt" placeholder="John" data-parsley-group="step-2" data-parsley-required="true" class="form-control" />
                                                                </div>
                                                            </div>
                                                            <!-- end form-group -->
                                                              <!-- begin form-group -->
                                                            <div class="form-group row m-b-10">
                                                                ...
                                                                <div class="col-md-6">
                                                                    <input type="text" name="official_middle_name_txt" placeholder="Doe" data-parsley-group="step-2" data-parsley-required="true" class="form-control" />
                                                                </div>
                                                            </div>
                                                            <!-- end form-group -->
                                                            <!-- begin form-group -->
                                                            <div class="form-group row m-b-10">
                                                                ...
                                                                <div class="col-md-6">
                                                                    <input type="text" name="official_last_name_txt" placeholder="Smith" data-parsley-group="step-2" data-parsley-required="true" class="form-control" />
                                                                </div>
                                                            </div>
                                                            <!-- end form-group -->
                                                        <!-- begin form-group -->
                                    ...
                                    <div class="col-md-6">
                                        <div class="input-group date" id="datetimepicker1">
                                            <input type="date" class="form-control"  name="official_birthdate_txt" data-parsley-group="step-2" data-parsley-required="true"/>
                                                ...
                                                <span class="glyphicon glyphicon-calendar"></span>
                                                           ...
                                                           <div class="col-md-6">
                                                            ...
                                                            <div class="form-group row m-b-10">
                                                                ...
                                                                <div class="col-md-6">
                                                                    <input type="text" name="municipal_position_name_txt" placeholder="City Attorney" data-parsley-group="step-2" data-parsley-required="true" class="form-control" />
                                                                </div>
                                                            </div>
                                                            <!-- end form-group -->
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-8 offset-md-2">
                                                            ...
                                                            <div class="form-group row m-b-10">
                                                                ...
                                                                <div class="col-md-6">
                                                                    <input type="text" name="account_username_txt" placeholder="johnsmithy" class="form-control" data-parsley-group="step-3" data-parsley-required="true" data-parsley-type="alphanum" />
                                                                </div>
                                                            </div>
                                                            <!-- end form-group -->
                                                            <!-- begin form-group -->
                                                            <div class="form-group row m-b-10">
                                                                ...
                                                                <div class="col-md-6">
                                                                    <input type="password"
                                                                     ...
                                                                     name="account_password_txt" placeholder="Your password" class="form-control" data-parsley-group="step-3" data-parsley-required="true"
                                                            ...
                                                            <div class="form-group row m-b-10">
                                                                ...
                                                                <div class="col-md-6">
                                                                    ...
                                                                    name="confirm_password_txt" placeholder="Confirmed password" class="form-control" data-parsley-group="step-3" data-parsley-required="true" 
                                                            ...
                                                            <div class="form-group row m-b-10">
                                                                ...
                                                                <div class="col-md-6">
                                                                    <input type="email" name="email_txt" placeholder="Your email" class="form-control" data-parsley-group="step-3" data-parsley-required="true" />
                                                                </div>
                                                            </div>
                                                            <!-- end form-group -->
                                                                  <!-- begin form-group -->
                                                            <div class="form-group row m-b-10">
                                                                ...
                                                                <div class="col-md-9">
                                                                    <input type="text" name="secret_question_txt" placeholder="Your secret question" class="form-control m-b-10" data-parsley-required="true" list="secret_question_list" />
                                                            ...
                                                            <div class="form-group row m-b-10">
                                                                ...
                                                                <div class="col-md-9">
                                                                    <input type="text" name="secret_answer_txt" placeholder="Answer to your secret question" class="form-control m-b-10" data-parsley-required="true" />
